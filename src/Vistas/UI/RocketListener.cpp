...
RocketFrameListener::RocketFrameListener(ModeloVista* modeloV):  FrameListeners(modeloV),  
  //,vista(0)
  context(0)
{
...
bool RocketFrameListener::configuraGraficos()
{
	FrameListeners::configuraGraficos();
