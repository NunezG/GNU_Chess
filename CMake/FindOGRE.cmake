...
elseif (UNIX)
  set(OGRE_PREFIX_GUESSES
    ...
    $ENV{HOME}/ogre
    $ENV{HOME}/OGRE
	/home/guidebian/Descargas/ogre_src_v1-9-0RC1Combile
    /home/guidebian/Descargas/ogre_src_v1-9-0RC1/OgreMain
  )
  if (APPLE)
    set(OGRE_PREFIX_GUESSES 
...
if (OGRE_PREFIX_SOURCE AND OGRE_PREFIX_BUILD)
  foreach(dir ${OGRE_PREFIX_SOURCE})
    set(OGRE_INC_SEARCH_PATH ${dir}/include ${dir}/include/OGRE ${dir}/OgreMain/include ${dir}/Dependencies/include ${dir}/iOSDependencies/include ${dir}/AndroidDependencies/include ${OGRE_INC_SEARCH_PATH})
    set(OGRE_LIB_SEARCH_PATH ${dir}/lib/Release/opt ${dir}/lib/Release ${dir}/lib ${dir}/Dependencies/lib ${dir}/iOSDependencies/lib ${dir}/AndroidDependencies/lib/${ANDROID_ABI} ${OGRE_LIB_SEARCH_PATH})
    set(OGRE_BIN_SEARCH_PATH ${dir}/Samples/Common/bin ${dir}/bin ${dir}/bin/Release ${OGRE_BIN_SEARCH_PATH})
  endforeach(dir)
  foreach(dir ${OGRE_PREFIX_BUILD})
    set(OGRE_INC_SEARCH_PATH ${dir}/include ${OGRE_INC_SEARCH_PATH})
    set(OGRE_LIB_SEARCH_PATH ${dir}/lib ${dir}/lib/Release ${dir}/lib/Release/opt ${OGRE_LIB_SEARCH_PATH})
  ...
  set(OGRE_PREFIX_SOURCE "NOTFOUNDsuputamadrte")
...
ogre_find_plugin(Plugin_OctreeSceneManager OgreOctreeSceneManager.h include/OGRE/Plugins/OctreeSceneManager)
